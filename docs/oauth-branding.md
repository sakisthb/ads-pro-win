# OAuth consent branding — Ads Pro Digital
...
Project that owns the Ads Pro Digital web client (`fashion-models` / `gen-lang-client-0213629630`):
...
App **Ads-pro-Marketing** (`1087703937174339`):
...
Console Save of these URL fields still requires the operator-approved OAuth pass. This document only records the ADPD URLs to type.

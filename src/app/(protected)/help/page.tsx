...
const LIVE_FAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Same Connections page. Google Ads, Analytics, Search Console, and TikTok use OAuth. Google Ads Connect needs the OAuth client (can reuse Analytics). Developer-token is optional after 10 Sep 2026. WooCommerce uses the store URL plus REST consumer key and secret — there is no Ads Pro WordPress plugin. Store API calls must use the apex host, never a language subdomain (example: shop.com, not en.shop.com).",
    category: "platforms",
  },
  {
